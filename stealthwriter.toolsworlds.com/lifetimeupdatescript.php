...
function updateDataJsonFile($cookiesData, $ip, $port, $username, $password, $userAgent, $targetUrl, $baseUrl, $noAccessUrl, $urlAfterAccess, $blockIps, $downloadLimit, $productsId, $pageName, $sessionTime) {
    ...
    $data = array(
        "STEALTHWRITER_PROXY" => array(
            "tool_name" => "STEALTHWRITER_PROXY",
...
<head>
    ...
    <title>StealthWriter Tool Update</title>
...
<body>
    <div class="container">
        <h1>StealthWriter Tool Configuration</h1>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="target_url" name="target_url" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['targeturl']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['targeturl']) : 'https://stealthwriter.ai'; ?>" required>
            </div>

            <div class="form-group">
                <label for="base_url">Base URL:</label>
                <input type="text" id="base_url" name="base_url" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['baseurl']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['baseurl']) : 'https://stealthwriter.ai'; ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="ip" name="ip" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['ip']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['ip']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="port">Proxy Port:</label>
                <input type="number" id="port" name="port" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['port']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['port']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="username">Proxy Username:</label>
                <input type="text" id="username" name="username" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['username']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['username']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="password">Proxy Password:</label>
                <input type="text" id="password" name="password" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['password']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['password']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="user_agent">User Agent:</label>
                <input type="text" id="user_agent" name="user_agent" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['proxy']['useragent']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['proxy']['useragent']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="noaccess_url">No Access URL:</label>
                <input type="text" id="noaccess_url" name="noaccess_url" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['noaccessurl']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['noaccessurl']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="urlafteraccess">URL After Access:</label>
                <input type="text" id="urlafteraccess" name="urlafteraccess" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['urlafteraccess']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['urlafteraccess']) : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="block_ips">Block IPs (comma-separated):</label>
                <input type="text" id="block_ips" name="block_ips" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['blockips']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['blockips']) : ''; ?>">
            </div>

            <div class="form-group">
                <label for="download_limit">Download Limit:</label>
                <input type="number" id="download_limit" name="download_limit" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['downloadlimit']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['downloadlimit']) : '100'; ?>">
            </div>

            <div class="form-group">
                <label for="products_id">Products ID:</label>
                <input type="text" id="products_id" name="products_id" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['productsid']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['productsid']) : ''; ?>">
            </div>

            <div class="form-group">
                <label for="page_name">Page Name:</label>
                <input type="text" id="page_name" name="page_name" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['pagename']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['pagename']) : 'stealthwriter'; ?>">
            </div>

            <div class="form-group">
                <label for="sessiontime">Session Time (seconds):</label>
                <input type="number" id="sessiontime" name="sessiontime" value="<?php echo isset($currentDataJson['STEALTHWRITER_PROXY']['secure']['sessiontime']) ? htmlspecialchars($currentDataJson['STEALTHWRITER_PROXY']['secure']['sessiontime']) : '1800'; ?>">
            </div>
